...
export default function Button({
	...
	const styles = {
		...
		secondary: `inline-block text-sm rounded-full border-2 border-stone-300 font-semibold tracking-wide focus:ring-offset-2 text-stone-400 uppercase focus:bg-stone-300 transition-colors duration-300  hover:text-stone-800 hover:cursor-pointer focus:ring-stone-200  
